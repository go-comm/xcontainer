...
func TestIntersectionInts(t *testing.T) {
	...
	var cases = []struct {
		...
		{Param1: []int{1}, Param2: []int{2}, Want: []int{}},
	}
...
func TestIntersectionUnstableInts(t *testing.T) {
	...
	for _, c := range cases {
		got := IntersectionUnstableInts(c.Param1, c.Param2)
		got = SortInts(got)
		if !EqualInts(c.Want, got) {
			t.Fatalf("param1: %v, param2: %v, want: %v, but got: %v", c.Param1, c.Param2, c.Want, got)
		}
...
func TestIntersectionSortInts(t *testing.T) {
